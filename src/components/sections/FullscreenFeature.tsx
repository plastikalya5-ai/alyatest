...
export default function FullscreenFeature() {
  return (
    <section className="relative grain overflow-hidden flex items-center bg-[#0b0e0b] min-h-[85svh]">
      ...
      <div className="relative z-10 w-full" style={{ paddingInline: "clamp(20px,5vw,80px)", paddingBlock: "clamp(80px,10vw,140px)" }}>
        <p className="eyebrow text-[#e55f28] mb-5" data-reveal>— Üretim Felsefemiz</p>
        <h2 className="heading text-[#eae6dd] mb-8" data-reveal data-delay="1"
        ...
        <p className="font-light leading-loose text-[#6b7366] mb-10" data-reveal data-delay="2"

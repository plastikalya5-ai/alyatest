...
const slides = [
  ...
  },
  {
    ...
    title: "3D SAKSI",
    desc: "Geometrik yüzeyi ile her açıdan farklı görünen 3D Saksı, modern interyör tasarımının vazgeçilmezi.",
    ...
    >
      <div style={{ paddingInline: "var(--pad)", paddingTop: 100 }}>
        <div className="flex justify-between items-center">
          <span className="eyebrow" style={{ color: "#727768" }}>
            ÜRÜN HİKÂYELERİ
          </span>
          <span className="eyebrow" style={{ color: "#727768" }}>
            01 — 04
      ...
      {slides.map((s, i) => (
        ...
        >
          <div>
            ...
            <h2
              className="display"
              style={{ fontSize: "clamp(90px, 12vw, 175px)", margin: "24px 0 34px" }}
            >
              {s.title}
            </h2>
            <p style={{ maxWidth: 260, fontSize: 15, lineHeight: 1.7, color: "#62675e" }}>
              {s.desc}
            </p>
            ...
            >
              {s.specs.map((sp) => (
                <div key={sp.dt}>
                  ...
                  <dd
                    style={{ margin: 0, font: "20px 'Courier New', monospace" }}
                  >
                    {sp.dd}
                  </dd>
                </div>
          ...
          <div
            className="relative"
            style={{ height: "65svh", maxHeight: 700, display: "grid", placeItems: "center" }}
          >
            <Image
              src={s.img}
              alt={s.title}
            ...
            />
            <span
              className="absolute bottom-0 right-0 eyebrow"
              style={{ fontSize: 11, color: "#70776b" }}
            >
              {s.code}
            </span>
          </div>

    ...
    <section id="contact" className="bg-[#111511]" data-bg="#111511" style={{ paddingBlock: "clamp(72px,9vw,130px)" }}>
      <div style={{ paddingInline: "clamp(20px,5vw,80px)" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
          {/* Sol */}
          <div>
            <p className="font-light leading-loose text-[#6b7366] text-sm max-w-[360px] mb-10" data-reveal>
            ...
            <address className="not-italic mt-8 text-[#6b7366] text-sm leading-loose" data-reveal>
